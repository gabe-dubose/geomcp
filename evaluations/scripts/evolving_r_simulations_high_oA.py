...
OPT_A = Z_0 * (1-R_0)*8 # --- optimal phenotype for alternative
...
# save to file
results_df.to_csv('../data/evolving_pleio_no_init_high_oA.csv', index=False)
...
results_df = pd.DataFrame(results)
# save to file
results_df.to_csv('../data/evolving_pleio_low_init_high_oA.csv', index=False)
...
results_df = pd.DataFrame(results)
# save to file
results_df.to_csv('../data/evolving_pleio_high_init_high_oA.csv', index=False)
